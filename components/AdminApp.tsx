...
const PAGE_SIZE=20;
const ownerTabs=[['dashboard','總覽'],['staff','館員管理'],['schedule','排班／請假'],['operations','營運管理'],['polaroids','拍立得管理'],['announcements','公告管理'],['rules','規章管理'],['settings','網站設定']];
