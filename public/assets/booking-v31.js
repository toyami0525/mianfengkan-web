...
const foods=[['主食','蛋包飯',7000],['主食','扇貝咖哩',9000],['主食','加雷馬披薩',9000],['主食','醬炒飯',7000],['主食','懸掛番茄沙拉',9000],['主食','羊駝奶油麵',7000],['主食','犎牛牛排',9000],['甜點','圓扇刺刺梨蛋糕',6000],['甜點','巧克力奶油蛋糕',6000],['甜點','白桃塔',8000],['甜點','蜂蜜牛角麵包',8000],['甜點','烏雞布丁',8000],['飲品','奶油熱巧克力',5000],['飲品','蜜瓜果汁',7000],['飲品','白桃汁',7000],['飲品','抹茶',7000],['飲品','路易波士紅茶',7000]].map((x,i)=>({id:i+1,category:x[0],name:x[1],price:x[2]}));
