...
const ownerTabs=[['dashboard','總覽'],['payroll','今日薪資'],['staff','館員管理'],['schedule','排班／請假'],['operations','營運管理'],['polaroids','成品管理'],['announcements','公告管理'],['rules','規章管理'],['settings','網站設定']];
